...
public interface IAlertService {
    ...
    AlertDTO.Response forwardAlert(Long id, AlertDTO.ActionRequest request, String operator);

    AlertDTO.Response dismissAlert(Long id, AlertDTO.ActionRequest request, String operator);

    AlertDTO.Response closeAlert(Long id, AlertDTO.ActionRequest request, String operator);
